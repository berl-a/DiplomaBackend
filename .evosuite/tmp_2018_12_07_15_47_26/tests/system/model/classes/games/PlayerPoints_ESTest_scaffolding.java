...
public class PlayerPoints_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "system.model.classes.games.PlayerPoints"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PlayerPoints_ESTest_scaffolding.class.getClassLoader() ,
      "system.model.classes.games.PlayerPoints"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PlayerPoints_ESTest_scaffolding.class.getClassLoader()); 
